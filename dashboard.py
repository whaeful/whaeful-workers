...
#fonts
    page.fonts = {
        ...
        "Oxanium": "/fonts/Oxanium.ttf",
        "Roboto": "/fonts/Roboto.ttf",
        "Antipasto": "/fonts/Antipasto.ttf",
        "Bringthatnoize": "/fonts/Bringthatnoize.ttf",
        "Fiexus": "/fonts/Fiexus.ttf",
        "Breamcatcher": "/fonts/Breamcatcher.otf",
        "Turnb": "/fonts/TURNB.ttf"

    }
    page.theme= ft.Theme(font_family="Oxanium")
    logo = ft.Container(
        content=ft.Image(
            src="/logos/whaeful.png",
            width=960,
            height=240
        ),
